...
export const PAYMENT_METHODS = ["pix", "dinheiro", "cartao", "transferencia", "outro"];
...
function sanitizeClient(c) {
  ...
  next.paymentMethod = pick(PAYMENT_METHODS, c.paymentMethod, "");
...
function sanitizeTransaction(t) {
  ...
  return {
    ...
    paymentMethod: pick(PAYMENT_METHODS, t.paymentMethod, ""),
  };
}
